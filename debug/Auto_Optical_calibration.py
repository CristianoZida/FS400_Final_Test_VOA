...
report_name='Optical_calibration_ITLA_{}_{}.csv'.format(typ,time_stamp)
...
input('Please connect ITLA output fiber directly to Power Meter port 1!\nPress any key and the calibration will start...')
