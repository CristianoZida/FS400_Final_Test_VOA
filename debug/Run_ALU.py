...
class main_test(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.board_up     = os.path.join(self.config_path,'Setup_brdup_CtrlboardA001_20220113_ALU.txt')
        self.drv_up       = os.path.join(self.config_path,'Setup_driverup_Ctrlboard56017837A002_20211203_ALU.txt')
        self.drv_down     = os.path.join(self.config_path,'Setup_driverdown_CtrlboardA001_20210820_ALU.txt')
        ...
        self.setWindowTitle('FS400 Final Test V2.0 - For ALU Driver test')
...
class WorkThread(QThread):
    ...
    def DC_test(self):
        ...
        #ALU driver jump connectivity test and board up here
