...
def er_judge(test_result,er_judgeIQ=20,er_judgeXY=20,di_judge=0):
    '''
...
# f=r'C:\Users\kc\Desktop\Jiawen_Zhou\ICR_Test\FS400_Final_Test_V2.0_0614_Eeprom\Test_report_TXDC\DC\Normal\WAAC250291_20220531_142145.csv'
# df=pd.read_csv(f)
# obj=a()
